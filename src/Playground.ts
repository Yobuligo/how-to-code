...
const first: number = 1016273612836;
const second: number = 1167361732;
...
function calc(operation: string, first: number, second: number): number {
  if (operation === "*") {
    return first * second;
  }
